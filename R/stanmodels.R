...
stanmodels <- c("alt_g", "alt_gl", "marg_dr_npp_g4", "marg_dr_npp_gl4", "marg_dr_npp_glpknown4", "marg_dr_pp_g4", "marg_dr_pp_gl4", "marg_dr_pp_glpknown4", "marg_f1_g", "marg_ndr_pp_g4", "marg_ndr_pp_gl4", "marg_ndr_pp_glpknown4")
...
Rcpp::loadModule("stan_fit4marg_f1_g_mod", what = TRUE)
